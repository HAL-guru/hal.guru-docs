#!/bin/bash
#
# @file halguru-clear-manual.sh
# @brief Clears all autogenerated manual files from the 'docs' directory.
#
# This script scans for files starting with the 'autogen-' prefix and removes them.
# It ensures that only files generated by 'halguru-generate-manual.sh' are cleared.
#
