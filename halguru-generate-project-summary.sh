...
generate_manual_files() {
  ...
  append_to_summary "| Markdown | Files | Lines | Average Lines |"
  append_to_summary "|----------|------:|------:|--------------:|"
  ...
  append_to_summary ""
  append_to_summary "Summary of the technical documentation"
  append_to_summary "available in the [public repository](https://github.com/HAL-guru/hal.guru-docs)."
  append_to_summary ""
  append_to_summary "* **Markdown Files** - total number of markdown files matching '*.md'"
  append_to_summary "* **Markdown Lines** - total number of lines across all markdown files"
  append_to_summary "* **Autogenerated Files** - total number of markdown files automatically generated by hal.guru matching 'autogen-*.md'"
  append_to_summary "* **Autogenerated Lines** - total number of lines in automatically generated markdown files"
  append_to_summary "* **Markdown Files** - total number of markdown files matching '*.md'"
  append_to_summary "* **Markdown Lines** - total number of lines across all markdown files"
  append_to_summary "* **Autogenerated Files** - total number of markdown files automatically generated by hal.guru matching 'autogen-*.md'"
  append_to_summary "* **Autogenerated Lines** - total number of lines in automatically generated markdown files"
