...
generate_manual_files() {
  ...
  local files_count=$(count_files "hal.guru-docs/docs" "*.md")
  local lines_count=$(count_lines "hal.guru-docs/docs" "*.md")
...
generate_git_table_row() {
  ...
  append_to_summary "| $name | $total_commits | $files_count | $lines_count | $created_date | $updated_date |"
